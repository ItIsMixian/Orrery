...
## Central integration normalization

- A4 Candidate `3d298a5c...` used numeric identifier ADR-0018 before integration. The unique integrator retained the
  already propagated authority-first ADR-0018 and allocated this decision canonical local ADR-0019 under ADR-0007/PO1.
- Identifier, filenames, links and inventory source paths changed atomically; decision status and semantics did not.
- The updated portable inventory uses LF canonical bytes as its digest domain, so Windows CRLF and LF checkout content
  produce digest `f786c4f2365e9b7b0e107d8365aba2ea5c81799b1b0a75a254a6aa06fe9eb7dd`; Core/Skill projections remain exact
  worktree bytes and tampered content still fails closed.
- Central focused A4/Adapter/wheel 15/15, routed Fast 84/84 and Checkpoint 89/89 pass. This is still an unreleased local
  integration Candidate without hosted Promotion or public/default transition.
