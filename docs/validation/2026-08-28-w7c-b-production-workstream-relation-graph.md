...
- W7B still owns automatic discovery, legacy migration, one local confirmation, apply/transition/undo and exact
  execution receipts. W7C-B exposes no placeholder execution control.
