...
- [ADR-0033: Dual-plane, Event-driven Orrery Coordination](0033-dual-plane-event-driven-orrery-coordination.md) — Accepted; separates Product/Decision discussion from Execution coordination, adds a quiet event inbox, provider-neutral task binding and bounded control snapshots, and records model choice as non-binding Local-only preference; implementation identity remains unallocated.
