# PO-DEC-WT-002: Local-first Team Mode 与跨机器元数据可见性

Status: Proposed

Date: 2026-08-20

Maintainer disposition: Approved for integration on 2026-08-20
...
> 这是候选分支上的稳定临时决策 ID。它记录维护者已经接受的方向，但在集成者分配正式 ADR 编号并合入 integration ref 前，不是 canonical effective ADR。
...
- Candidate Implementation Plan: [2026-08-19 多 worktree 协作协议](../../implementation/plans/2026-08-19-multi-worktree-collaboration-protocol.md)
