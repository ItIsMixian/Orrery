...
- H2 候选、读取代理、JSONL 独立 validator、可选 Hook 和原始证据保留工具位于 `experiments/context-routing/`；研究层 `bb2c768` 与权威状态层 `96bfd21` 已通过纯快进进入本地 `main`。当前尚未推送远端，也没有新 Release。
...
5. H2 研究轮已经关闭。后续若提出新的路由候选，应建立新 Design、新 Pilot 和冻结质量门；不要改写 Pilot 004、Pilot 005／006 或十份 smoke 原始结果，也不要为当前 H2 创建采纳 ADR。
