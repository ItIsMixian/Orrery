...
| 多 Workstream 协作 | W1–W7 Canonical 基线与 ADR-0017 不变；ADR-0020 已接受 W program/W5-W7 phase hierarchy；W7.3 Core/capture 保留而 Graph 仍在改 | 原 W7.3 改为严格 module-scoped 输入、单次 immutable component layout、完整 occupied-bounds packing、无 phase 外框与局部短扇出；保留 Core/capture，任何确认/apply/删除仍逐次本机授权 |
