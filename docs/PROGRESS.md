...
- [ ] [Orrery v0.3.0 Final RC and Promotion](implementation/plans/2026-08-30-v0-3-0-release-candidate-and-promotion.md)：exact `e120aaa...` Candidate 36/36、双根 package、final ZIP Harness、真实 Codex、Unified lifecycle、v0.2 upgrade/migrate/restore、dependency failure 与 Skill lifecycle 全绿。下一步推 exact `promotion/v0.3.0-rc` 并等待双 required checks；GitHub Release 仍 withheld。
...
1. 推 exact `e120aaa...` 到 `promotion/v0.3.0-rc`，验证 remote equality 并取得 Windows/Ubuntu required checks。
