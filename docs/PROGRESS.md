...
- [ ] [Orrery v0.3.0 Final RC and Promotion](implementation/plans/2026-08-30-v0-3-0-release-candidate-and-promotion.md)：revision 7 已把 pending 收敛为四条并恢复 Core-only `derived_from` authority；维护者确认 1280/390 预览。下一步冻结 source、CI7 dry-run 后各跑一次 fresh Fast/Checkpoint，再做 final exact-SHA 页面 gate。
