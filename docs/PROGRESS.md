...
- [ ] [Orrery v0.3.0 Final RC and Promotion](implementation/plans/2026-08-30-v0-3-0-release-candidate-and-promotion.md)：revision 6 已把七条 pending 收敛为四条；剩余 lineage 卡错误提供 human Accept/gate。revision 7 按 ADR-0017 恢复 Core-only `derived_from` authority，只留 defer/reject；先看页面、再 fresh route，之后才注册 Sol-medium Final RC。
