...
- W7.2 Worktree Candidate 声明 Core 0.1.17、CLI 0.1.21、Observatory 0.1.13；Core／CLI 与关系 schema/facts 不变，Observatory 只推进 Graph 可读性、渐进展开和 facts-first lens presentation。组件总状态为 `unreleased`，Core API／CLI JSON schema 仍为 1。
