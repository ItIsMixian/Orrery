...
- 三个未发布组件初始版本均为 `0.1.0`；Canonical source 已依次完成 W1 Phase 0／1，当前 Core 0.1.4、CLI 0.1.9、Observatory 0.1.0，Core API 仍为 1。旧 `skills/project-orrery/scripts/` 路径是薄 wrapper，并保留可独立运行的冻结 v0.2 fallback；保留承诺覆盖 `0.3.x`，最早 `0.4.0` 才可移除。
