...
Governing ADRs: [ADR-0004](../decisions/0004-platform-neutral-core-and-adapter-boundaries.md), [ADR-0007](../decisions/0007-multi-worktree-collaboration-and-branch-fact-scopes.md)
...
- ADR-0007 的多人协作协议已经进入权威链，但 `orrery worktree create/status/overlap` 与 `orrery integrate` 仍只是 Approved Design 中的候选工具面；当前 CLI、Skill 和发布资产都没有这些命令，也没有升级版本或发布新产物。
...
- 多 worktree 自动化尚无 schema、CLI、观测台投影或 CI 门禁。当前仅能依靠 Git 原生命令、独立 worktree 和人工验证执行协议。
