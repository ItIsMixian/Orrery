...
- W4／W5A 联合 non-main Candidate 的 W4+W5 focused 为 26/26，动态全仓为 316 项中 313 PASS + 3 个既有 Windows symlink privilege skips；integrated structure、legacy/W4 隔离站点、340 份 Markdown／874 个本地链接／0 unexpected missing、schema、secret／forbidden 与 diff 门通过。该证据不构成 Canonical integration、真实多机 LAN 或 Team UI 支持；exact-SHA 双平台门与维护者确认仍待完成。
