...
- W2 将 collaboration 专项扩展到 27/27：覆盖五类路径来源、四类 finding、registry mapping、独占门、L1/L2/L3、route gate、lifecycle、ack 失效和跨成员 `1/2 → 2/2`。集成树默认全仓 278 项中 273 PASS + 5 existing skips；integrated structure、隔离静态站、335 份 Markdown／855 个链接／0 unexpected missing、secret／forbidden 与 diff 门通过，动态跨平台结果由本轮 Candidate-first CI 记录。
