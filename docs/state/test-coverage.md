...
- ADR-0007／ADR-0008 的当前 W6 Worktree Candidate 覆盖 W1–W3 Personal contract、W4 health Personal 指挥台、W5A loopback Team Core／CLI、root-only W5C Team UI 与 W6 Phase 0–2 maintenance。仍无 Phase 3 自动删除、Phase 4 scheduler、自动发现或真实多机 LAN 证据；本分支只有 Windows 本机 focused/checkpoint/browser 证据，promotion 仍要求中央 Candidate 与 containing docs SHA 的规定门。
