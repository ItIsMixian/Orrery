...
- [2026-08-29 CI7 Validation Routing Precision, Acceptance Gates & Total-Cost Diagnostics](plans/2026-08-29-ci7-validation-routing-precision-and-cost-diagnostics.md) — retains provider-neutral routing/cost diagnostics and implements maintainer-approved composable gates, surface-bound freshness, one-run leases, no-repeat blocking and predictive headroom without changing stage authority or budgets.
