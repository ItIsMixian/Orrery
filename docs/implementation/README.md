...
- [2026-08-19 multi-worktree collaboration protocol](plans/2026-08-19-multi-worktree-collaboration-protocol.md) — candidate plan ready after provisional decision `PO-DEC-WT-001` receives a formal ADR number at integration.
