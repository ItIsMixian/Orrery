...
- [v0.3.0 Release Notes](v0.3.0-release-notes.md), [Onboarding](v0.3.0-onboarding.md) and
  [Upgrade/Rollback](v0.3.0-upgrade-rollback.md) — branch-scoped Final RC guidance; publication remains pending.

- [2026-08-30 Orrery v0.3.0 Final RC and Promotion](plans/2026-08-30-v0-3-0-release-candidate-and-promotion.md) — Phase 0 complete: revision-11 Fast 19/19 + Checkpoint 30/30 and exact Unified SHA `a2d7737...` accepted; Phase 1 Final RC dispatch is ready.
