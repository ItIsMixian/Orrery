...
- [2026-08-21 M2.2 Observatory Authority Candidate projection](plans/2026-08-21-m2-2-observatory-authority-projection.md) — active Worktree Candidate; consumes the M2.1 bundle under an explicit opt-in and preserves an independently rollbackable legacy default.
- [2026-08-21 M2.3 Authority Model 1 release/installer candidate gate](plans/2026-08-21-m2-3-authority-release-candidate-gate.md) — Worktree Candidate validated, integration pending; validates a maintainer-supplied next-release manifest, offline package/install, explicit migration/restore and rollback without selecting a public SemVer, changing v0.2.0 history or starting M2.2.
