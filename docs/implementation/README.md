...
- [2026-08-29 W7.3 Workstream Relation Capture & Confirmation](plans/2026-08-29-w7-3-workstream-relation-capture.md) — active implementation of automatic exact-base lineage, four dependency gates, role-bound human confirmation, task-series metadata and separate comparison/conflict semantics; paused pending exact authority-SHA acknowledgment.
