...
- [2026-08-29 CI7 Validation Routing Precision & Total-Cost Diagnostics](plans/2026-08-29-ci7-validation-routing-precision-and-cost-diagnostics.md) — Worktree Candidate implements provider-neutral routing precision, fail-closed scope metadata and advisory total-cost receipts; exact-SHA hosted Promotion remains central integration work.
