...
- [2026-08-19 multi-worktree collaboration protocol](plans/2026-08-19-multi-worktree-collaboration-protocol.md) — active for the ADR-0007 baseline with candidate expansion under PO-DEC-WT-002; Personal foundation precedes review/cleanup and opt-in Team Mode.
