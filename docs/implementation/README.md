...
- [2026-08-29 W7.3 Workstream Relation Capture & Confirmation](plans/2026-08-29-w7-3-workstream-relation-capture.md) — revision-17 focused Candidate closeout implements relation capture/confirmation, program/series presentation metadata and the pinned local ELK read-only Graph; integrated Fast/Checkpoint and public/default/release transitions remain central follow-up work.
