...
Status: Active for ADR-0007 baseline; candidate expansion pending integration
...
> ADR-0007 基线已接受；Team Mode、Local-only telemetry 和后续体验细化在当前分支仍是 Candidate scope。当前恢复与集成工作只证明人工隔离流程可行；完成清单不等于功能已经实现，State 只能记录已经验证的实际行为。
