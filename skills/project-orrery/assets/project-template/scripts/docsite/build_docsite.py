...
def render_site(docs_dir: Path, agents_file: Path, root: Path, title="{{PROJECT_TITLE_PY}} · Documentation"):
...
def main():
    ...
    ap.add_argument("--title", default="{{PROJECT_TITLE_PY}} · Documentation")
    args = ap.parse_args()
