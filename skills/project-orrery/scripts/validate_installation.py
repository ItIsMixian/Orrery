#!/usr/bin/env python3
"""Compatibility entry for the platform-neutral Project Orrery validator."""
...
def main() -> int:
    if source_cli_available():
        ...
        from project_orrery_cli.validate import main as validate_main

        return validate_main(context=skill_context(SKILL_ROOT))
    runpy.run_path(str(SCRIPT.with_name("_legacy_validate_installation.py")), run_name="__main__")
    return 0
