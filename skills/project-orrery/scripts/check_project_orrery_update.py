#!/usr/bin/env python3
"""Compatibility entry for the platform-neutral Project Orrery update checker."""
...
def main() -> int:
    if source_cli_available():
        ...
        from project_orrery_cli.update import main as update_main

        return update_main(context=skill_context(SKILL_ROOT))
    runpy.run_path(str(SCRIPT.with_name("_legacy_check_project_orrery_update.py")), run_name="__main__")
    return 0
