...
WORKSTREAM_RELATIONS_SCHEMA = _read_schema("workstream-relations-v1.json")
WORKSTREAM_RELATION_EXECUTION_SCHEMA = _read_schema("workstream-relation-execution-v1.json")
