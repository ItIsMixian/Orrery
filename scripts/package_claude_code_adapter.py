#!/usr/bin/env python3
"""Build the experimental Claude Code adapter archive and checksum."""
...
def main() -> int:
    ...
    archive = output / f"project-orrery-claude-code-adapter-v{version}.zip"
    checksum = output / f"project-orrery-claude-code-adapter-v{version}.sha256"
    prefix = "project-orrery-claude-code"
